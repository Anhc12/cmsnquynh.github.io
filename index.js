const contentLetterSrart_actived = "Chúc Mừng Sinh Nhật Bé Như Quỳnh❤️"; //Lời mở đầu cho bức thư
const mainContentLetter =
  "Chúc EM sinh nhật tuổi mới xinh đẹp nhiều niềm vui, chúc cho em tuổi mới sớm có được ANH 😄."; //Nội dung của bức thư
